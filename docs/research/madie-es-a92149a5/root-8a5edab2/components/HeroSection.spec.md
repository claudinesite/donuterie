...
## Overview
- Target: `src/components/sites/madie-es-a92149a5/root-8a5edab2/HeroSection.tsx`
...
- Background image fills inset 0 with `object-fit:cover`; desktop uses 1440×855 image, mobile uses 843×1540 image. Add a burgundy/black overlay dense enough to match the reference.
...
- CTA desktop: x68, y785, rose background, 12.48px Dazzle, 1.248px tracking, 28×14px padding, 46.7px high, pill radius.
- Language pills appear top-right within hero on desktop/mobile, active ES cream with burgundy text.
...
## Hover
- CTA rose → cream; translate Y -2px; gap 12→16px; 150ms.
